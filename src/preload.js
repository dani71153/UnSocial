...
contextBridge.exposeInMainWorld('api', {
  ...
  // Labels & Filters
  setFeedLabels: (username, platform, labels) => ipcRenderer.invoke('set-feed-labels', username, platform, labels),
  setFeedFilters: (username, platform, filters) => ipcRenderer.invoke('set-feed-filters', username, platform, filters),
